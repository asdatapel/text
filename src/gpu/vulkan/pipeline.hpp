...
VkShaderModule create_shader_module(VkDevice device, String shader_bytes)
{
  VkShaderModuleCreateInfo create_info{};
  create_info.sType    = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
  create_info.pCode    = reinterpret_cast<const u32 *>(shader_bytes.data);
...
Pipeline create_pipeline(Device *device, PipelineDefinition shaders_definition,
                         ...
                         VkRenderPass render_pass, u32 push_constant_size)
{
  ...
  VkShaderModule vert_shader_module =
      create_shader_module(device->device, vert_shader_file.data);
  VkShaderModule frag_shader_module =
      create_shader_module(device->device, frag_shader_file.data);
...
Pipeline create_pipeline(Device *device, String vertex_shader_bytes,
                         String fragment_shader_bytes,
                         Array<VkDescriptorSetLayout, 4> descriptor_set_layouts,
                         ...
                         VkRenderPass render_pass)
{
  ...
  VkShaderModule vert_shader_module =
      create_shader_module(device->device, vertex_shader_bytes);
  VkShaderModule frag_shader_module =
      create_shader_module(device->device, fragment_shader_bytes);
...
void set_scissor(Device *device, Rect4f rect)
{
  VkRect2D scissor{};
